...
Este arquivo define processo. Ele não é fonte autônoma de schemas, valores, fórmulas, IDs, classes ou balanceamento.
...
5. identifique fallback, normalização e consumidores;
...
- atualize `data/README.md` quando loader, fallback ou organização do diretório mudar;
